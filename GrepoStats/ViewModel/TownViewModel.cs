...
namespace GrepoStats.ViewModel
{
    public class TownViewModel : ViewModelBase
    {
        ...
        private const string RemoteFilePath = @"http://fr74.grepolis.com/data/towns.txt.gz";
        private const string LocalFilePath = @"C:\Grepolis\towns.txt.gz";
        private const string ExtractedFileName = @"C:\Grepolis\towns.txt";
